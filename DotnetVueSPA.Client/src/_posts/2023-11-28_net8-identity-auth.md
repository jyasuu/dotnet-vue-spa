...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/DotnetVueSPA/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/DotnetVueSPA.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/DotnetVueSPA/Program.cs):
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/DotnetVueSPA/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[DotnetVueSPA.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/DotnetVueSPA/DotnetVueSPA.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/DotnetVueSPA/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/DotnetVueSPA/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/DotnetVueSPA/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/DotnetVueSPA/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/DotnetVueSPA/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/DotnetVueSPA/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/DotnetVueSPA/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/DotnetVueSPA.ServiceInterface/EmailServices.cs) in a 
