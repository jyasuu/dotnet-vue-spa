...
const project = ref('DotnetVueSPA')
const projectZip = computed(() => (project.value || 'DotnetVueSPA') + '.zip')

/** @param {string} template */
const zipUrl = (template:string) =>
    `https://account.servicestack.net/archive/${template}?Name=${project.value || 'DotnetVueSPA'}`
